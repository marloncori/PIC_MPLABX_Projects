...
;  4 buttons are wired to RB7-4 and they have pull-down resistors 
;  (connected to Vss). Apart from that, there is another button wired to RB0
...
; TODO PLACE VARIABLE DEFINITIONS GO HERE
 ...
 #define LED_RB   PORTA,RA1
 #define LED_RB0  PORTA,RA2
;*******************************************************************************
 CBLOCK	    H'20'
    OLD_STATUS
    OLD_W
...
FOR	    
	    ...
	    RETURN
;--------------- RB0 and RB INTERRUPT SERVICES ROUTINE ------------------------- 
RB_RB0_ISR
	    ; SAVE CONTEXT
	    ...
	    BCF		LED1		    ; apaga led1
	    BCF		LED2		    ; apaga led2
	    BTFSS	INTCON,INTF	    ; checa a flag da interrupcao rb0
	    BTFSS	INTCON,RBIF	    ; checa a flag da interrupcao rb
	    GOTO	INT_RB0
	    GOTO	INT_RB
INT_RB0
	    BSF		LED_RB0
...
REPEAT	    CALL	DELAY_500ms	    ; this loop is need to generate
